...
export default function CtaButton({ button_text }) {
    ...
    return (
        <div onClick={handleClick} className="w-115 h-115 p-2 bg-red-500 flex flex-col justify-between cursor-pointer max-lg:w-100 max-lg:h-100 max-lg:shrink-0 max-md:w-60 max-md:h-60">
