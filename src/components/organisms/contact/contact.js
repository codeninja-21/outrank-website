    ...
    return (
        <section className="w-full h-screen">
            <div className="w-full h-full flex flex-col">
                <div className="px-8 pt-8 pb-5 border-b-2 border-neutral-600 shrink-0">
                    <h1 className="display-lg text-red-500">Contact</h1>
                </div>
                <div className="w-full flex-1 flex flex-row">
                    <div className="min-w-120 p-8 flex flex-col justify-between border-r-2 border-neutral-600 max-lg:hidden">
                        <div className="mt-5 flex flex-col gap-12">
                            <div className="flex flex-col gap-2">
                                <p className="body-md text-neutral-100">Address</p>
                                <p className="body-xsm text-neutral-600">Lesanpuro 5 Ville, 7283</p>
                                <p className="body-xsm text-neutral-600">New York City</p>
                            </div>
                            <div className="flex flex-col gap-2">
                                <p className="body-md text-neutral-100">FITNESS COACH</p>
